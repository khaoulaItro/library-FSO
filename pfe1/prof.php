<?php
    ...
    {
      $p=md5($pass);
      $sql=mysqli_query($set,"SELECT * FROM prof WHERE aid='$aid' AND password='$pass'");
      if(mysqli_num_rows($sql)==1)
      {
        $_SESSION['aid']=$_POST['aid'];
        header("location:./kb/emprprof.php");
      }
      else
      {
...
<body>
  ...
  <div align="center">
    <div id="wrapper">
      <br>
      <br>
      <span class="SubHead">Identification prof</span>
      <br>
      <br>
      <form method="post" action="">
        <table border="0" cellpadding="4" cellspacing="4" class="table">
            ...
            <tr>
                ...
                <td>
                   <input type="text" name="aid" class="fields" size="25" placeholder="Entrer le nom d'utilisateur" required="required">
                </td>
            </tr>
            <tr>
                <td class="labels">Mot de passe : </td>
                <td>
                   <input type="password" name="pass" class="fields" size="25" placeholder="Entrer mot de passe " required="required">
                </td>
            </tr>
            <tr>
