      ...
      <div class="container-fluid" id="header">
          <div class="row">
              ...
              <div class="col-md-3 col-lg-3" id="offer">
                  ...
                  <a href="http://localhost/app/kb/Product.php?value=MATHEMATIQUE">        <img class="img-responsive center-block" src="img/offers/2.png"></a>
                  <a href="http://localhost/app/kb/Product.php?value=PHYSIQUE"> <img class="img-responsive center-block" src="img/offers/3.png"></a>
              </div>
          </div>
      </div>
  </div>
      ...
      <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  <h2 style="color:#D67B22;">Site FSO</h2>
                  <div>
                      <a href="http://FSO.ump.ma/">
                      <img title="FSO" alt="FSO" src="img/social/EST.png" width="35" height="35" />
                      </a>
...
<div class="container">
  ...
  <button type="button" id="_button" class="btn btn-lg" data-toggle="modal" data-target="#query">CONTACTEZ NOUS!</button>
