      ...
      <div class="container-fluid" id="header">
          <div class="row">
              ...
              <div class="col-md-3 col-lg-3" id="offer">
                  ...
                  <a href="http://localhost/app/kb/block2.php?value=MATHEMATIQUE">        <img class="img-responsive center-block" src="img/offers/2.png"></a>
                  <a href="http://localhost/app/kb/block2.php?value=PHYSIQUE"> <img class="img-responsive center-block" src="img/offers/3.png"></a>
              </div>
          </div>
      </div>
  </div>
