<?php
	...
	if($bn!=NULL && $ba!=NULL)
	{
		$sql=mysqli_query($set,"INSERT INTO request(name,author,aid) VALUES('$bn','$ba','$aid')");
		if($sql)
		{
			...
			<form method="post" action="">
				<table border="0" class="table" cellpadding="10" cellspacing="10">
					...
					<tr>
						...
						<td><input type="text" size="25" class="fields" required="required" name="name" placeholder="Entrer le nom de livre"></td>
					</tr>
					<tr>
						<td class="labels">Auteur : </td>
						<td><input type="text" size="25" class="fields" required="required" name="author" placeholder="Enter le nom de l'auteur"></td>
					</tr>
					<tr>
						<td colspan="2" align="center"><input type="submit" class="fields" value="Demander"></td>
					</tr>
				</table>
			</form>
			<br>
